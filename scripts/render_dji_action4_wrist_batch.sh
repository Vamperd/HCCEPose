...
OUTPUT_DATASET_PATH="${OUTPUT_DATASET_PATH:-${REPO_ROOT}/dji-action4-real-wrist-jacket-occlusion}"
...
MATERIAL_START="${MATERIAL_START:-900}"
MATERIAL_STOP="${MATERIAL_STOP:-1000}"
OBJECT_COUNT="${OBJECT_COUNT:-2}"
VIEWS_PER_SCENE="${VIEWS_PER_SCENE:-20}"
OCCLUSION_PROFILE="${OCCLUSION_PROFILE:-light}"
WRIST_SIZE_SCALE="${WRIST_SIZE_SCALE:-2.0}"
WRIST_DECIMATE_RATIO="${WRIST_DECIMATE_RATIO:-0.25}"
JACKET_SIZE_SCALE="${JACKET_SIZE_SCALE:-1.0}"
JACKET_XY_SCALE="${JACKET_XY_SCALE:-0.75}"
JACKET_DECIMATE_RATIO="${JACKET_DECIMATE_RATIO:-0.10}"
JACKET_TOP_Z="${JACKET_TOP_Z:-0.02}"
JACKET_FRONT_UP_AXIS="${JACKET_FRONT_UP_AXIS:-pos_x}"
JACKET_EXPOSED_HEIGHT="${JACKET_EXPOSED_HEIGHT:-0.3}"
...
echo "[INFO] JACKET_XY_SCALE=${JACKET_XY_SCALE}"
...
echo "[INFO] JACKET_EXPOSED_HEIGHT=${JACKET_EXPOSED_HEIGHT}"
...
for (( material_index=MATERIAL_START; material_index<MATERIAL_STOP; material_index++ )); do
    ...
    python "${PY_SCRIPT}" \
        ...
        --jacket-xy-scale "${JACKET_XY_SCALE}" \
